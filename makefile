...
all : Client Serveur Gerant Publicite Caddie AccesBD CreationBD 
...
#FichierClient.o a mettre apres serveur point cpp a la ligne du dessus

#FichierClient.o:	FichierClient.cpp
#		g++ FichierClient.cpp -c
